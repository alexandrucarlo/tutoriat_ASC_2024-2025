...
# inmultim de doua ori eax cu el insusi (ATENTIE - INCORECT!!!)
# imull %eax
# imull %eax # daca pur si simplu inmultim de doua ori cu el, nu obtinem n^3, ci n^4 (ex 5*5=25, 25*25=625=5^4)

# copiem valoarea originala a lui eax si facem inmultirea folosind copia
movl %eax, %edi # salvam valoarea originala a lui eax in alt registru (oricare in afara de cele folosite deja, si edx (pentru ca va fi modifcat de imul))
imull %edi
imull %edi # inmultim de doua ori eax cu edi - va da raspunsul corect
